...
const Hero = () => {
  return (
    <div className="flex flex-col items-end bg-[url(/hero_bg.png)] bg-cover bg-no-repeat bg-[center_top_-14rem] h-[300px] md:h-[500px] w-full rounded-[50px] shadow-2xl ring-1 ring-gray-300">
